    ...
    <workexperience>
      ...
      <activities><![CDATA[ <?php echo strip_tags(utf8_encode(unhtmlentities($vars['entity']->description))); ?> ]]></activities>
      <employer>
        ...
        <sector>
          <code><?php echo $vars['entity']->sector; ?></code>
          <label><![CDATA[ <?php echo elgg_echo('resume:sector:' . $vars['entity']->sector); ?> ]]></label>
        </sector>
      </employer>
    </workexperience>

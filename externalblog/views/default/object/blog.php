...
<?php
			...
			// Now handled by annotation framework
				...
				// Facyla 20110202 : décommenter la ligne suivante si par malheur les commentaires anonymes ont été activés puis désactivés (cause un pb d'affichage des commentaires qui peut être réglé via la ligne suivante, mais produit un doublon si tout fonctionne bien)
//			if (!isloggedin()) echo elgg_view_comments($vars['entity']);
